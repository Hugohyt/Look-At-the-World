...
- (void)loadTextView{
    ...
    self.inputTextView.inputAccessoryView = [[UIView alloc] initWithFrame:CGRectZero];
...
//        self.articleTableView.keyboardDismissMode = UIScrollViewKeyboardDismissModeNone;
//            self.articleTableView.contentInsetAdjustmentBehavior = UIScrollViewContentInsetAdjustmentNever;
    }];
}
