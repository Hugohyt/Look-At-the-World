...
- (void)viewDidLoad {
    ...
    self.audioDetailsView.tableView.sectionFooterHeight = 10;
    self.audioDetailsView.tableView.sectionHeaderHeight = 10;
    self.audioDetailsView.tableView.estimatedRowHeight = 50;
    self.audioDetailsView.tableView.contentInset = UIEdgeInsetsMake(-30, 0, 0, 0);
